...
const Faq = () => {
  return (
    ...
    <div className="relative w-full bg-gray-900 px-6 pt-10 pb-8 mt-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
      <div className="mx-auto px-5">
        <div className="flex flex-col items-center">
          <h2 className="mt-5 text-center text-3xl text-blue-600 font-bold tracking-tight md:text-5xl">
            FAQ
          </h2>
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3 text-white">
                ...
                you can contact the companys support team by submitting a
          ...
          <div className="py-5">
            <details className="group">
              ...
              <p className="group-open:animate-fadeIn mt-3 text-white">
                ...
                up for the companys newsletter or follow it on social media.
              </p>
            </details>
          </div>
        </div>
