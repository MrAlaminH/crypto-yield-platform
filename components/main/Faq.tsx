...
const Faq = () => {
  return (
    ...
    <div className="relative w-full bg-gray-900 px-6 pt-10 pb-12 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-2xl sm:rounded-lg sm:px-10">
      <div className="mx-auto px-5">
        <div className="flex flex-col items-center">
          <h2 className="mt-5 text-center text-4xl text-blue-600 font-bold tracking-tight md:text-5xl">
            FAQ
          </h2>
