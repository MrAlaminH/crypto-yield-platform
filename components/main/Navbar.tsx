...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <nav className="fixed w-full z-20 top-0 border-b border-gray-200 bg-gray-900 md:hidden">
        <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
          ...
          <div className="flex">
            <button
              type="button"
              className="font-semibold bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:outline-none focus:ring-blue-300 shadow-lg shadow-blue-500/50 rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 mt-2"
            >
              Wallet Connect
            </button>
          </div>
      ...
      <nav className="hidden md:flex fixed w-full z-20 md:top-0 md:border-b border-gray-200 bg-gray-900">
          ...
          <div className="flex items-center space-x-8">
            <ul className="flex flex-row font-medium space-x-8 ">
              <li>
                <Link
                  href="/stake"
                  className="flex items-center gap-2 py-2 px-3 text-blue-700 md:text-blue-700 md:p-0"
                  aria-current="page"
                >
              ...
              <li>
                <Link
                  href="/unstake"
                  className="flex items-center gap-2 py-2 px-3 text-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0"
                >
                  <BsStars /> Unstake
                </Link>
              </li>
